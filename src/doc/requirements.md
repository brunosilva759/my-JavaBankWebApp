...
2. Customers should be able to have multiple checking accounts;
3. Customers should be able to have multiple savings accounts;
4. Checking account balance can not be negative;
5. Savings account balance can not be lower than 100;
6. Savings account requires transfer of at least minimum balance to become active;
7. Customer should be able to deposit money in any of its checking accounts;
8. Customer should be able to withdraw money from any of its checking accounts, provided it has sufficient funds;
9. Customer should be able to transfer money between any of its accounts;
10. Customer should be able to check balance of any account;
11. Customer should be able to check combined balance of all accounts;
12. Bank should be able to check the combined balance of all customers;
...
* Inheritance used with generic Account class and specific CheckingAccount and SavingsAccount
  classes;
